# +++ Modified By [telegram username: @Spicesupport41
import os
...
APP_ID = int(os.environ.get("APP_ID", "21811939"))
API_HASH = os.environ.get("API_HASH", "4fd0c2221b0b0748d80fb3ce17335bec")

# Main
OWNER_ID = int(os.environ.get("OWNER_ID", "8394624724"))
PORT = os.environ.get("PORT", "8080")

# Database
DB_URI = os.environ.get("DB_URI", "mongodb+srv://spicememz_db_user:X8XAsP7mdwlLug4l@cluster0.hutyrr2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DB_NAME", "link")

#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '').split()] # dont change anything 
TEXT = environ.get("APPROVED_WELCOME_TEXT", "<b>{mention},\n\nʏᴏᴜʀ ʀᴇǫᴜᴇsᴛ ᴛᴏ ᴊᴏɪɴ {title} ɪs ᴀᴘᴘʀᴏᴠᴇᴅ.\n\‣ ᴘᴏᴡᴇʀᴇᴅ ʙʏ @Spicesupport41</b>")
...
# Start pic
START_PIC = "https://i.supaimg.com/ccc371cf-5532-4158-9292-451ca27eefea.jpg"
START_IMG = "https://i.supaimg.com/ccc371cf-5532-4158-9292-451ca27eefea.jpg"
# Messages
...
DATABASE_CHANNEL = int(os.environ.get("DATABASE_CHANNEL", "-1003195167965")) # Channel where user links are stored
#--- ---- ---- --- --- --- - -- -  - - - - - - - - - - - --  - -
